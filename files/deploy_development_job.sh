...
IMAGE_TAG=latest envsubst < crawler-deployment.yml | kubectl delete -f - -n dev --kubeconfig=/opt/kubeconfig
kubectl delete -f ./kubernetes/crawler-service.yml -n dev --kubeconfig=/opt/kubeconfig
IMAGE_TAG=latest envsubst < ui-deployment.yml | kubectl delete -f - -n dev --kubeconfig=/opt/kubeconfig
...
IMAGE_TAG=latest envsubst < grafana-deployment.yml | kubectl delete -f - -n dev --kubeconfig=/opt/kubeconfig
...
IMAGE_TAG=latest envsubst < crawler-deployment.yml | kubectl apply -f - -n dev --kubeconfig=/opt/kubeconfig
kubectl apply -f ./kubernetes/crawler-service.yml -n dev --kubeconfig=/opt/kubeconfig
IMAGE_TAG=latest envsubst < ui-deployment.yml | kubectl apply -f - -n dev --kubeconfig=/opt/kubeconfig
...
IMAGE_TAG=latest envsubst < grafana-deployment.yml | kubectl apply -f - -n dev --kubeconfig=/opt/kubeconfig
