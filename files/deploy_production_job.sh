...
kubectl delete -f ./kubernetes/crawler-deployment.yml -n prod --kubeconfig=/opt/kubeconfig
kubectl delete -f ./kubernetes/crawler-service.yml -n prod --kubeconfig=/opt/kubeconfig
kubectl delete -f ./kubernetes/ui-deployment.yml -n prod --kubeconfig=/opt/kubeconfig
...
kubectl delete -f ./kubernetes/grafana-deployment.yml -n prod --kubeconfig=/opt/kubeconfig
